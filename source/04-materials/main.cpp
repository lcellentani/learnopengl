...
int main() {
	...
	StringUtils::ReadFileToString("04-materials.vs", params.mVertexShaderData);
	StringUtils::ReadFileToString("04-materials.fs", params.mFragmentShaderData);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		ShaderProgram_SetVec3(programHandle, "u_material.ambient", 1.0f, 0.5f, 0.31f);
		ShaderProgram_SetVec3(programHandle, "u_material.diffuse", 1.0f, 0.5f, 0.31f);
		ShaderProgram_SetVec3(programHandle, "u_material.specular", 0.5f, 0.5f, 0.5f);
		...
		ShaderProgram_SetVec3(programHandle, "u_light.ambient", ambientColor);
		ShaderProgram_SetVec3(programHandle, "u_light.diffuse", diffuseColor);
